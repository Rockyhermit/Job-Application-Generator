...
I have a first-class {degree} from {university}, and I have worked for {exprerience_years} as a {previous_position} with {previous_company}. My work experience includes {work_expirence_includes}. Given my understanding and passion, I believe I will be a good fit for the position in your company.

Enclosed please find my resume and work samples hope you find this in order.
